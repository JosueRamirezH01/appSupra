...
abstract class TechniciansRepository {
  ...
  Future<TechnicianApplicationModel> updateMyProfile(UpdateTechnicianProfileRequest request);
...
abstract class AdminRepository {
  ...
  Future<TechnicianApplicationModel> reject(int userId, RejectApplicationRequest request);
